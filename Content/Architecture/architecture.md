...
- [常用架构设计方法论](#常用架构设计方法论)
    ...
    - [架构设计的流程](#架构设计的流程)
    - [高性能架构模式](#高性能架构模式)
    - [软件负载均衡的优缺点：](#软件负载均衡的优缺点)
    - [异地多活设计4大技巧](#异地多活设计4大技巧)
    - [跨城异地多活架构设计的 4 个步骤](#跨城异地多活架构设计的-4-个步骤)
    - [如何应对接口级的故障](#如何应对接口级的故障)
    - [可扩展的基本思想](#可扩展的基本思想)
    - [SOA ：“面向服务的架构”, SOA 提出了 3 个关键概念](#soa-面向服务的架构-soa-提出了-3-个关键概念)
    - [SOA 和微服务的关系和区别：](#soa-和微服务的关系和区别)
    - [微服务的陷阱/微服务具体有哪些坑：](#微服务的陷阱微服务具体有哪些坑)
    - [微服务拆分方法：](#微服务拆分方法)
    - [面向功能拆分：微内核架构。](#面向功能拆分微内核架构)
    - [微服务基础设施](#微服务基础设施)
