- [说透芯片](#说透芯片)
  - [基础知识](#基础知识)
    ...
    - [集成电路](#集成电路)
    - [摩尔定律](#摩尔定律)
    - [从一部iPhone手机看芯片的分类](#从一部iphone手机看芯片的分类)
    - [数字 IC](#数字-ic)
    - [CPU：计算设备的运算核心和控制核心](#cpu计算设备的运算核心和控制核心)
    - [GPU：图形处理器](#gpu图形处理器)
    - [ASIC：为解决特定应用问题而定制设计的集成电路](#asic为解决特定应用问题而定制设计的集成电路)
    - [存储芯片：DRAM 和 NAND Flash](#存储芯片dram-和-nand-flash)
    - [iPhone X 中的模拟 IC](#iphone-x-中的模拟-ic)
    - [一颗芯片到底是如何诞生的](#一颗芯片到底是如何诞生的)
    - [产业链分工视角：设计、制造、封装、测试的分工合作](#产业链分工视角设计制造封装测试的分工合作)
    - [IDM 模式](#idm-模式)
  - [Top10 半导体公司](#top10-半导体公司)
    - [Intel的发展史就是一部芯片行业的创新史](#intel的发展史就是一部芯片行业的创新史)
    - [三星：资本与技术共舞的40年](#三星资本与技术共舞的40年)
    - [台积电：摩尔定律的忠实执行者](#台积电摩尔定律的忠实执行者)
    - [Nvidia 与AI 芯片：超越摩尔定律](#nvidia-与ai-芯片超越摩尔定律)
    - [德州仪器：模拟芯片的无冕之王](#德州仪器模拟芯片的无冕之王)
    - [其他半导体公司：美国双通与欧洲双雄](#其他半导体公司美国双通与欧洲双雄)
  - [中国的机会](#中国的机会)
    - [2000 年之前：国家计划与政策扶持](#2000-年之前国家计划与政策扶持)
    - [2000 年 -2014 年：市场带动产业发展](#2000-年--2014-年市场带动产业发展)
    - [2014 年后：投资产业时代](#2014-年后投资产业时代)
    - [紫光集团](#紫光集团)
    - [中国的巨大市场机会](#中国的巨大市场机会)
# 说透芯片
