...
<!-- vscode-markdown-toc -->
* 1. [MySQL 常见几种索引类型](#MySQL)
* 2. [MyISAM 和 InnoDB 索引实现](#MyISAMInnoDB)
	* 2.1. [MyISAM 索引实现](#MyISAM)
	* 2.2. [InnoDB 索引实现](#InnoDB)
		* 2.2.1. [Innodb 的聚集索引](#Innodb)
		* 2.2.2. [Innodb 如何选择一个聚集索引](#Innodb-1)
		* 2.2.3. [建立自增主键的原因是：](#)
	* 2.3. [聚集索引和非聚集索引解释](#-1)
* 3. [索引的缺点](#-1)
* 4. [注意事项](#-1)
	* 4.1. [SQL 索引优化案例分析](#SQL)
		* 4.1.1. [创建表](#-1)
* 5. [Explain](#Explain)
	* 5.1. [Explain 参数解析](#Explain-1)
* 6. [参考文章](#-1)
...
##  1. <a name='MySQL'></a>MySQL 常见几种索引类型
...
##  2. <a name='MyISAMInnoDB'></a>MyISAM 和 InnoDB 索引实现

###  2.1. <a name='MyISAM'></a>MyISAM 索引实现
...
###  2.2. <a name='InnoDB'></a>InnoDB 索引实现
...
####  2.2.1. <a name='Innodb'></a>Innodb 的聚集索引
...
####  2.2.2. <a name='Innodb-1'></a>Innodb 如何选择一个聚集索引
...
###  5.1. <a name='Explain-1'></a>Explain 参数解析
