- [深入浅出计算机组成原理](#深入浅出计算机组成原理)
	- [基础篇](#基础篇)
		- [计算机的基本硬件组成](#计算机的基本硬件组成)
		- [CPU](#cpu)
	- [指令和运算](#指令和运算)
		- [CPU指令](#cpu指令)
		- [编译链接](#编译链接)
	...
	- [处理器](#处理器)
		- [指令 + 运算](#指令--运算)
		- [CPU指令周期和流水线](#cpu指令周期和流水线)
		- [CPU冒险](#cpu冒险)
		- [异常的分类：中断、陷阱、故障和中止](#异常的分类中断陷阱故障和中止)
		- [CISC和RISC](#cisc和risc)
		- [GPU](#gpu)
		- [FPGA和ASIC](#fpga和asic)
	- [存储与I/O系统](#存储与io系统)
		- [存储器层次结构全景](#存储器层次结构全景)
		- [CPU 读取数据过程](#cpu-读取数据过程)
		- [安全性与内存保护](#安全性与内存保护)
		- [总线](#总线)
		- [CPU 是如何控制 I/O 设备的？](#cpu-是如何控制-io-设备的)
		- [理解 DMA，一个协处理器](#理解-dma一个协处理器)
	- [应用篇](#应用篇)
		- [KV vs MQ VS 数据仓库](#kv-vs-mq-vs-数据仓库)
		- [Cassandra：顺序写和随机读](#cassandra顺序写和随机读)
# 深入浅出计算机组成原理
